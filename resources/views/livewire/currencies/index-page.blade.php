<div>
    <x-ui.page-header title="Currencies" description="Manage how money is displayed across invoices, payments, expenses, receipts, and reports.">
        <x-slot:actions>
            @can('create', \App\Models\Currency::class)
                <x-ui.action-link href="{{ route('currencies.create') }}" variant="primary">
                    Add Currency
                </x-ui.action-link>
            @endcan
        </x-slot:actions>
