<div>
    <div class="mb-6">
        <a href="{{ route('inventory-items.index') }}" class="mb-2 inline-block text-blue-600 hover:text-blue-900 dark:hover:text-blue-400">
            <i class="fas fa-arrow-left mr-1"></i> Back to Inventory Items
        </a>
        <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Create Inventory Item</h1>
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Add a new inventory item with item type, category, pricing, and stock behavior.</p>
    </div>
    ...
    <div class="mb-6 max-w-4xl rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <form wire:submit="save">
            @include('livewire.inventory_items.partials.form-fields')

            <div class="flex justify-end border-t border-gray-200 pt-4 dark:border-gray-700">
                <a href="{{ route('inventory-items.index') }}" class="mr-3 rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm transition hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700">
                    Cancel
                </a>
