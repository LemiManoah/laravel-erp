<div>
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">New Purchase Order</h1>
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Plan what should be ordered from a supplier before the stock arrives.</p>
    </div>
    ...
    <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <form wire:submit="save">
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div>
                    <label class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">Order Number <span class="text-red-500">*</span></label>
                ...
                <div>
                    ...
                    <input type="date" wire:model="order_date" class="w-full rounded-md border border-gray-300 px-3 py-2 text-sm dark:border-gray-600 dark:bg-gray-700 dark:text-white">
                ...
                <div>
                    ...
                    <input type="date" wire:model="expected_date" class="w-full rounded-md border border-gray-300 px-3 py-2 text-sm dark:border-gray-600 dark:bg-gray-700 dark:text-white">
                ...
                <div>
                    ...
                    <select wire:model="status" class="w-full rounded-md border border-gray-300 px-3 py-2 text-sm dark:border-gray-600 dark:bg-gray-700 dark:text-white">
            ...
            <div class="mt-6 flex items-center justify-between border-t border-gray-200 pt-4 dark:border-gray-700">
                ...
                <div class="flex gap-3">
                    <a href="{{ route('purchase-orders.index') }}" class="rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm transition hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700">Cancel</a>
                    <button type="submit" class="rounded-md bg-blue-600 px-6 py-2 text-sm font-medium text-white shadow-sm transition hover:bg-blue-700">Save Purchase Order</button>
                </div>
            </div>
        </form>
    </div>
