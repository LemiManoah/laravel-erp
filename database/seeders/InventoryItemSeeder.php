...
final class InventoryItemSeeder extends Seeder
{
    ...
    {
        $categories = ItemCategory::query()->get()->keyBy('name');
        $units = UnitOfMeasure::query()->get()->keyBy('abbreviation');

        foreach ($this->inventoryItems() as $itemData) {
            ...
            $inventoryItem = InventoryItem::query()->updateOrCreate(
                ...
                [
                    ...$itemData,
                    'item_category_id' => $categories->get($category)?->id,
                    'base_unit_id' => $unit === null ? null : $units->get($unit)?->id,
                    'parent_item_id' => $parentItemName === null
                        ? null
                        : InventoryItem::query()->where('name', $parentItemName)->value('id'),
                ],
            );
    ...
    private function inventoryItems(): array
    {
        return [
            ...
            [
                ...
                'item_type' => InventoryItemType::FinishedGood,
                'tracks_inventory' => true,
                'is_sellable' => true,
                'is_purchasable' => true,
                'base_unit' => 'box',
            ...
            [
                ...
                'item_type' => InventoryItemType::RawMaterial,
                'tracks_inventory' => true,
                'is_sellable' => true,
                'is_purchasable' => true,
                'base_unit' => 'bag',
            ...
            [
                ...
                'item_type' => InventoryItemType::NonStockItem,
            ...
            [
                ...
                'item_type' => InventoryItemType::Service,
                'tracks_inventory' => false,
                'is_sellable' => true,
                'is_purchasable' => false,
                'base_unit' => null,
