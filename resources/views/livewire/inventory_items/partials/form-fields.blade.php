...
<div class="grid grid-cols-1 gap-5 md:grid-cols-2">
    <div>
        <label for="item_category_id" class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">Item Category</label>
        <select
            id="item_category_id"
    ...
    <div>
        ...
        >
            ...
            @foreach($parentInventoryItems as $parentInventoryItem)
                <option value="{{ $parentInventoryItem->id }}">{{ $parentInventoryItem->name }}</option>
            @endforeach
        </select>
