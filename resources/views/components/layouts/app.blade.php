            ...
            <main class="flex-1 overflow-auto bg-gray-100 dark:bg-gray-900 content-transition">
                <div class="p-6">
                    @if(session('status') || session('success') || session('error'))
                        <div x-data="{ showFlashMessage: true }" x-show="showFlashMessage"
                            ...
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                                    <svg @class([
                                            'h-5 w-5',
                                            'text-green-500 dark:text-green-400' => session('status') || session('success'),
                                            'text-red-500 dark:text-red-400' => session('error'),
                                        ])
                                ...
                                <div class="ml-3">
                                    <p @class([
                                        'text-sm',
                                        'text-green-700 dark:text-green-200' => session('status') || session('success'),
                                        'text-red-700 dark:text-red-200' => session('error'),
