<div>
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Use this advanced page for direct ledger entry. For everyday work, prefer the dedicated Receive Stock and Stock Adjustment pages.</p>
    </div>
