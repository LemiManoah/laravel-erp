<div>
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">Track low stock inventory items and expiry-sensitive stock rows from one place.</p>
        </div>
    ...
    <div class="mb-6 grid grid-cols-1 gap-4 md:grid-cols-4">
        <div class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <p class="text-sm text-gray-500 dark:text-gray-400">Tracked Items</p>
            <p class="mt-2 text-2xl font-semibold text-gray-900 dark:text-white">{{ $summary['tracked_inventory_items'] }}</p>
        </div>
        <div class="rounded-lg border border-amber-200 bg-amber-50 p-4 shadow-sm dark:border-amber-800 dark:bg-amber-900/20">
            ...
            <p class="mt-2 text-2xl font-semibold text-amber-900 dark:text-amber-100">{{ $summary['low_stock_inventory_items'] }}</p>
        </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        @forelse($lowStockInventoryItems as $inventoryItem)
                            <tr>
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="px-6 py-4 text-center text-sm text-gray-500 dark:text-gray-400">No low stock inventory items right now.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
