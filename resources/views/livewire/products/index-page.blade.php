<div>
    ...
    @if($confirmingDeletion)
        <div class="relative z-50" aria-labelledby="product-delete-modal-title" role="dialog" aria-modal="true">
                    ...
                    <div class="relative transform overflow-hidden rounded-lg border border-gray-200 bg-white text-left shadow-xl transition-all dark:border-gray-700 dark:bg-gray-800 sm:my-8 sm:w-full sm:max-w-lg">
                        <div class="bg-white px-4 pb-4 pt-5 dark:bg-gray-800 sm:p-6 sm:pb-4">
                            <div class="text-center sm:text-left">
                                <h3 class="text-lg font-semibold leading-6 text-gray-900 dark:text-white" id="product-delete-modal-title">
                                    Delete Confirmation
                                </h3>
                        ...
                        <div class="border-t border-gray-200 bg-gray-50 px-4 py-3 dark:border-gray-700 dark:bg-gray-900 sm:flex sm:flex-row-reverse sm:px-6">
                            <button type="button" wire:click="deleteProduct" class="inline-flex w-full justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-red-500 sm:ml-3 sm:w-auto">
                                Delete
                            </button>
