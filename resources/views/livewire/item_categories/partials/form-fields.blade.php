<div class="space-y-6">
    ...
    <div class="flex gap-3">
        ...
        <a href="{{ route('item-categories.index') }}" class="rounded-md border border-gray-300 px-4 py-2 text-sm text-gray-700 transition hover:bg-gray-50 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-700">Cancel</a>
    </div>
</div>
