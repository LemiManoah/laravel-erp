<div>
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Create Item Category</h1>
    </div>

    <div class="max-w-3xl rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <form wire:submit="save">
            @include('livewire.product_categories.partials.form-fields', ['submitLabel' => 'Save Item Category'])
        </form>
    </div>
</div>
