<div>
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">New Currency</h1>
    </div>
    <div class="max-w-4xl rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <form wire:submit="save">
            @include('livewire.currencies.partials.form-fields', ['submitLabel' => 'Save Currency'])
        </form>
    </div>
</div>
