<div>
    <div class="mb-6">
        <a href="{{ route('invoices.show', $invoice) }}" class="mb-2 inline-block text-blue-600 hover:text-blue-900 dark:hover:text-blue-400">
    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                ...
                <button type="button" wire:click="update" class="mt-6 w-full rounded-md bg-blue-600 px-4 py-2 font-semibold text-white transition hover:bg-blue-700">
                    Update Invoice
                </button>
                <a href="{{ route('invoices.show', $invoice) }}" class="mt-2 block text-center text-sm text-gray-500 hover:text-gray-700">Cancel</a>
            </div>
        </div>
    </div>
</div>
