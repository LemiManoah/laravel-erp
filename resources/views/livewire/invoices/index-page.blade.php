<div>
    <x-ui.page-header title="Invoices" description="Track invoice status, balances, and customer billing activity.">
        <x-slot:actions>
            @can('create', \App\Models\Invoice::class)
                <x-ui.action-link href="{{ route('invoices.create') }}" variant="primary">
