<x-layouts.app title="Create Product">
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Add a new product or item to your catalog.</p>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6 border border-gray-200 dark:border-gray-700 mb-6 max-w-2xl">
        <form action="{{ route('products.store') }}" method="POST">
            ...
            <div class="pt-4 border-t border-gray-200 dark:border-gray-700 flex justify-end">
                ...
                <button type="submit" class="px-6 py-2 bg-blue-600 text-white rounded-md shadow-sm text-sm font-medium hover:bg-blue-700 transition">Create Product</button>
            </div>
        </form>
    </div>
</x-layouts.app>
