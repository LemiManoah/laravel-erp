<div>
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Create Stock Location</h1>
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Add a new warehouse, store, or storage area.</p>
    </div>
