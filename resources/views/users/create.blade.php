        ...
        <form action="{{ route('users.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="flex items-center gap-3 pt-7">
                    ...
                    <input type="checkbox" name="is_active" id="is_active" value="1" @checked(old('is_active', '1') === '1')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                        @foreach($roles as $roleName)
                            <label class="flex items-center gap-3 p-3 border border-gray-300 dark:border-gray-600 rounded-md dark:bg-gray-700">
                                <input type="checkbox" name="roles[]" value="{{ $roleName }}" @checked(in_array($roleName, old('roles', []), true))
                                    class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
